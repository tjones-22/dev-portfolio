...
export default function Home() {
  ...
  <section className=" flex flex-col items-center justify-around w-screen  lg:h-[40vh] lg:w-[80] border-spacing-1 mt-[10vh]  mb-[10vh] text-[20px] ">
  ...
  <Typewiter />
    ...
    <div className="flex flex-col  lg:flex-row items-center justify-around w-[100%]  min-h-fit mb-[10vh] p-1 ">
      ...
      <img 
        ...
        className="headshot-img w-[20vw] h-[20vh] lg:w-[20vh] lg:h-[20vh]"
      />
  ...
  <h2 className=" text-center text-[40px] font-bold underline italic mb-[10vh]"> Projects</h2>
  <ScrollSection />
  ...
  <section className="w-screen h-fit pb-2">
    <div>
      ...
      <div className=" flex flex-col items-center justify-evenly  w-[40%] h-[60vh]">
  ...
  <div className="bg-blue-800 text-yellow-500 p-10">
    <h2 className="text-center text-[25px] lg:text-[30px] font-bold"> Currently looking for:</h2>
    <ul className=" list-disc  text-[30px] flex flex-col lg:flex-row w-screen items-center justify-evenly mt-[10vh]">
      <li className="mr-[10vw] lg:mr-0">Front End Internship</li>
      <li className=" mr-[10vw] lg:mr-0"> Back End Internship</li>
      <li className=" mr-[10vw] lg:mr-0">Fullstack Internship </li>
    </ul>
  </div>
  </>
